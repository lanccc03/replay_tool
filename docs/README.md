...
- `ui-style-guide.md`：PySide6 工作台的项目专属 UI 补充规则；通用团队工具 UI 风格以 `.codex/skills/tool-ui-style` 为准。
- `ui-implementation-roadmap.md`：PySide6 工作台从当前工程工作台到完整 UI 的长期实现路线、阶段验收和维护规则。
- `ui-manual-validation.md`：PySide6 真实窗口点击、高 DPI、可访问性和手工验证记录模板。
