...
- 当前 PySide6 UI 已覆盖 Trace Library 的 Import / Inspect / Rebuild / Delete 闭环、Scenario Store schema v2 draft 编辑 / 保存 / Validate / Run、Replay Monitor mock / app 层 session 控制、Devices mock / app 层枚举，以及 Settings 产品化状态页；CLI / core 改动通常不需要 Qt 手工点击验证。
