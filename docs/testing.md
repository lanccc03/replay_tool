...
- 当前 PySide6 UI 已覆盖 Trace Library 的 Import / Inspect / Rebuild / Delete 闭环、Scenario Store schema v2 draft 编辑 / 保存 / Validate / Run、Replay Monitor 第一批 Mock session 控制，以及 Devices 第一批 app 层枚举；CLI / core 改动通常不需要 Qt 手工点击验证。
