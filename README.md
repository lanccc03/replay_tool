...
The current active workbench pages are Trace Library, Scenarios, Replay
Monitor, and Devices. DBC / Signal Override, diagnostics, DoIP, ZLG, BLF, high
DPI checks, real window click checks, dark theme, packaging, and Windows
